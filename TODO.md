...
## [x] Bug: R面が左右逆に出力される [2026-06-10 18:27 完了]

## [x] --view front を追加、これをデフォルトにする [2026-06-11 12:05 完了]

F 面を正面にして出力するオプションを追加する。
cabinet 投影で F 面を正方形の正面に、U/R を斜め奥に描画。`--view` のデフォルトを `front` に変更。model.rs に `ViewMode::Front`、svg.rs に投影定数、README 更新。
